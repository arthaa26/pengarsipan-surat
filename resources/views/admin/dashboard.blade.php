...
<style>
    ...
    /* Style khusus untuk menu yang aktif (Dashboard) */
    .sidebar-menu a[href*="dashboard"].active-menu {
...
<div class="main-content-col">
    ...
    {{-- TABLE: HISTORY SURAT (Menampilkan SEMUA surat) --}}
    <div class="table-container mt-5">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover mt-0">
                ...
                <tbody>
                    {{-- LOOPING DATA HISTORY SURAT dari Controller. Menggunakan $suratMasuk --}}
